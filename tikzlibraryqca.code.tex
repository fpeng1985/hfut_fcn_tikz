...
% \pgfutil@definecolor{cell_color_4}{RGB}{128,128,128}
...
\tikzset{
    in tile/.style args={#1 #2}{
        ...
        every label/.style={fill=none, minimum size=0,label distance=1},
    } 
}